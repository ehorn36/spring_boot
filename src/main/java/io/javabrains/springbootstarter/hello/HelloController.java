...
handling incoming HTTP requests from the outside world. It acts as the entry point for your application logic. In Spring Boot, @RestController is a specific type of controller annotation used to build RESTful web services. */
@RestController
